...
(define (install-deriv-package)
  ...
  ; -> later in the book we see that constructors are not part of the package (they need to be exposed to
  ; make the code usable at a higher level !)
...
; see diff with <filename>_d.scm file.
; note that I didn't change `get` and `put` signature, though it would make sense to (the semantics of arguments changed).
