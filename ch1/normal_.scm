; https://people.eecs.berkeley.edu/~bh/61a-pages/Lectures/1.1/order.scm
; THIS DOES NOT LOAD PROPERLY FOR SOME REASON.
; Leaving this for now, maybe at some point we'll get more comfortable with macros and can run/fix this.
